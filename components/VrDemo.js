...
var VrDemo = (function (_super) {
    ...
    function VrDemo(props) {
        ...
        _this.vrAssetsData = _this.props.store.vrAssetsData;
        ...
        if (!AFRAME.components["chang-box"]) {
            AFRAME.registerComponent("chang-box", {
                init: function () {
                    ...
                    var boxScale = window.document.getElementById("box_scale");
        ...
        return (React.createElement("div", { className: "ar-demo pt-4" },
            React.createElement("a-scene", { "data-aframe-inspector": "true" },
                React.createElement("a-assets", null,
                    React.createElement("a-asset-item", { id: "envGltf", src: "static/gltf/fantasy_sky_background/scene.gltf" })),
                ...
                React.createElement("a-entity", { id: "cameraWrapper", position: "0 1 5" },
                    React.createElement("a-entity", { camera: "active: true", "look-controls": "true", "wasd-controls": "true", "mouse-cursor": "true" },
                        React.createElement("a-entity", { cursor: "fuse: true; fuseTimeout: 500; rayOrigin: mouse entity;", position: "0 0 -1", geometry: "primitive: ring; radiusInner: 0.02; radiusOuter: 0.03", material: "color: black; shader: flat" }))),
                React.createElement("a-entity", { id: "box", "chang-box": "", geometry: "", material: "color:#ff00f8", position: "1.62512 0 -7.72419", rotation: "0 -73.42282257262961 0" },
    ...
    __decorate([
        observable
    ], VrDemo.prototype, "vrAssetsData", void 0);
    VrDemo = __decorate([
        inject("store"),
        observer
    ], VrDemo);
