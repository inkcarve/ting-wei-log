...
class VrDemo extends React.Component<any, any> {
  ...
  componentDidMount() {
    ...
    if (!AFRAME.components["chang-box"]) {
      AFRAME.registerComponent("chang-box", {
        init() {
          let lastIndex = 2;
          const styles = [
            {
  ...
  @observable vrAssetsData = this.props.store.vrAssetsData;
  ...
  render() {
    ...
    <a-assets>
      <a-asset-item id="envGltf" src="static/gltf/fantasy_sky_background/scene.gltf" />
    </a-assets>
    <a-gltf-model src="#envGltf" position="0 0 0">
      <a-animation attribute="rotation" begin="500" easing="linear" dur="22000" from="0 0 0" to="0 360 0" repeat="indefinite"></a-animation>
    </a-gltf-model>
    ...
    <a-text position="-1.46653 2 -2.40167" welcome-text="" value="Look The Box" side="double" align="center" geometry="primitive:plane;width:1.7;height:0.5" material="color:#FFFFFF;side:double;emissive:#ffffff;opacity:0.2" text="" scale="1.000000140492798 1.000000140492798 1.000000140492798" rotation="-54.86471958834224 -64.32425278595214 89.29661828672906">
      ...
      <a-animation begin="0" dur="2000" direction="alternate" attribute="rotation" from="-54.86471958834224 -64.32425278595214 89.29661828672906" to="-4.172851621937786 11.256328843140153 -20.21223213883005" repeat="indefinite"></a-animation>
    </a-text>
...
{/* <a-text position="3.28525 2 -3.30167" value="Look the Box" side="double" align="center" geometry="primitive:plane;width:1.7;height:0.5;" material="color:#FFFFFF;side:double;emissive:#ffffff;opacity:0.2" text="" scale="1.0951892739202171 1.0951892739202171 1.0951892739202171" rotation="5.24053630398914 -46.60746378484842 0">
    ...
    <a-entity id="cameraWrapper" position="0 1 5">
      <a-entity camera="active: true" look-controls="true" wasd-controls="true" mouse-cursor="true">
        <a-entity cursor="fuse: true; fuseTimeout: 500; rayOrigin: mouse entity;" position="0 0 -1" geometry="primitive: ring; radiusInner: 0.02; radiusOuter: 0.03" material="color: black; shader: flat"></a-entity>
      </a-entity>
    </a-entity>

<a-entity id="box" chang-box="" geometry="" material="color:#ff00f8" position="1.62512 0 -7.72419" rotation="0 -73.42282257262961 0">
      <a-animation id="box_scale0" begin="box_scale0" dur="1000" direction="normal" attribute="scale" from="1 1 1" to="3 3 3" repeat="0"></a-animation>
      <a-animation id="box_scale1" begin="box_scale1" dur="1000" direction="normal" attribute="scale" from="3 3 3" to="0.5 0.5 0.5" repeat="0"></a-animation>
      <a-animation id="box_scale2" begin="box_scale2" dur="1000" direction="normal" attribute="scale" from="0.5 0.5 0.5" to="1 1 1 " repeat="0"></a-animation>
    </a-entity>
    <a-entity light="type: ambient; intensity: 0.1;">
        <a-animation begin="0" dur="2000" direction="alternate" attribute="light.intensity" from="0.1" to="0.4" repeat="indefinite" end=""></a-animation>
    </a-entity>

<a-entity light="type:spot;color:#96f7ff;intensity:0.6;penumbra:1;castShadow:true" position="7.30778 4.66448 -1.34723" rotation="-27.079704271268103 0 0">
    </a-entity>
  </a-scene>
