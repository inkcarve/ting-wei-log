            ...
            <div className="row justify-content-center">
              <div className="col-12 p-0 position-relative">
                <div className="embed-responsive embed-responsive-16by9 position-relative index-bg-box d-flex align-items-center">
                  ...
                  <a className="btn btn-outline-light mr-4 px-md-5 py-md-4 mb-3 col-md-12 col-lg-10 col-xl-8" href="/vr"><h3>VR</h3></a>
                ...
                <a className="btn btn-outline-primary px-2 py-2 mb-3 col-8" href="/vr"><h4>VR</h4></a>
