...
export default {
  ...
  projects: [
    ...
    //   titleEn: "",
    //   detail:
    //     "王道銀行行動對帳單、深圳農商銀行對帳單、成都農商銀行對帳單...還有一些正在進行項目。"
    // }
  ],
  jobs: [
    {
      listGroup: [
        {
          title: "景丞科技股份有限公司 網頁前端工程師",
          titleEn: "2016/08 ~ present(在職)",
          content:
            '參與過<a href="https://card.apply.hsbc.com.tw/hsbcoa/credit_card/select_your_card" target="_blank">HSBC信用卡線上開戶</a>、王道銀行行動對帳單、深圳農商銀行對帳單（中國）、成都農商銀行對帳單（中國）、上海裕順內部對帳單專案（中國）...還有一些正在進行項目'
        },
        { title: "其他", titleEn: "other", content: "請洽本人" }
      ]
    }
  ]
};
