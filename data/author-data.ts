...
const badgeNew = ' <span class=\"badge badge-primary text-white\">new</span>';
export default {
  basic: [
  ...
  projects: [
    ...
    },
    {
      ...
      detail:
        '<a href="https://road-of-ting-wei.herokuapp.com" target="_blank">Here</a>'
    },
    {
      title: "HSBC信用卡線上開戶",
      titleEn: "",
      detail:
        '<a href="https://card.apply.hsbc.com.tw/hsbcoa/credit_card/select_your_card" target="_blank">Go Now!</a>'
    },
    {
      title: "舊的個人網站",
      titleEn: "Old Personal Web Site(2015~2016)",
      detail:
        '<a href="http://vincent0423.byethost3.com/index.html" target="_blank">Are You Sure want to go ?</a>'
    }
  ],
  jobs: [
    {
      listGroup: [
        {
          ...
          content:
            '參與過<a href="https://card.apply.hsbc.com.tw/hsbcoa/credit_card/select_your_card" target="_blank">HSBC信用卡線上開戶</a>、王道銀行行動對帳單、深圳農商銀行對帳單（中國）、成都農商銀行對帳單（中國）、上海裕順內部對帳單專案（中國）...還有一些正在進行項目。<br>除了一般網頁製作，亦參與過 Web Accessibility 專案。'
        },
        {
          title: "精銳合威股份有限公司",
