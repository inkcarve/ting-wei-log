...
export default {
    ...
    info: [
        { title: "", titleEn: "", detail: "Hi, I'm a web frontend engineer. Actually I had been a junior graphic designer or others. But I think could be a React Native Enigeneer / Web Frontend Enigeneer Now." +
    ...
    skill: [
        ...
        },
        {
            title: "Style",
            titleEn: "",
            detail: " Bootstrap(3, 4), Scss, ng-Bootstrap(Angular), Bootstrap-Vue(Vue), reactstrap(react), UI-Bootstrap(AngularJs), font-awesome..."
        },
        {
            title: "Web Framework",
            titleEn: "",
            ...
            listGroup: [
                ...
                {
                    title: "AngularJs",
                    content: "angular-ui-bootstrap, angular-slick-carousel, ng-device-detector, ui-select"
                }
            ]
        },
        {
        ...
        },
        {
            title: "Other",
            titleEn: "",
            detail: "A-Frame" + badgeNew + ", redux" + badgeNew + ", Webpack, Jquery, NodeJs+Express+helmetJs" + badgeNew + ", mobx...",
            listGroup: []
        }
    ],
    otherSkill: [
...
//# sourceMappingURL=author-data-en.js.map